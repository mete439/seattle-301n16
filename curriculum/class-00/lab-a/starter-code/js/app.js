...
function displayPics(){
  ...
  // theis error happended becuase  I changed var to const and const doesnt acess out side the scope, but var can acess outside the scope.
  // when I commet out console.log(rando), the the app start working on the browser.
  //// since let changed to const, the loops counts or contacnated  doesnt work. the const variable needs initializations, but not let and then I changed loops and
  // other changed value variables changed to let the it works.
  console.log(viewed);
